...
inline void splitstr(const std::string& str, Container& cont, const std::string& delims = " ") {
...
template <class Container>
inline void splitwstr(const std::wstring& str, Container& cont, const std::wstring& delims = L" ") {
  std::size_t current, previous = 0;
  current = str.find_first_of(delims);
