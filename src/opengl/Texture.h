...
class Texture : public GLObject {
 public:
  ...
  void SetSubImage3D(const uint8_t* data, uint32_t xoffset, uint32_t yoffset, uint32_t zoffset, uint32_t width, uint32_t height, uint32_t depth,
                     uint32_t overrideFormat = 0);
