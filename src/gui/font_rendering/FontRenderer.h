...
public:
    ...
    FontFamily *CreateFontFamily(const std::string &name, uint32_t size = 12, std::string regularFileName = "", std::string boldFileName = "", std::string italicFileName = "", std::string boldItalicFileName = "");
