...
FontFamily::~FontFamily() {
  if (_fonts[FFT_REGULAR] != nullptr)
    delete _fonts[FFT_REGULAR];
  if (_fonts[FFT_BOLD] != nullptr)
    delete _fonts[FFT_BOLD];
  if (_fonts[FFT_ITALIC] != nullptr)
    delete _fonts[FFT_ITALIC];
  if (_fonts[FFT_BOLD_ITALIC] != nullptr)
    delete _fonts[FFT_BOLD_ITALIC];
}
