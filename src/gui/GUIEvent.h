...
#define GUI_BEGIN_ON_EVENT(e)             \
  if (this->event_listener) {             \
    if (this->event_listener->OnEvent(e)) \
      return true;                        \
  }
#define GUI_END_ON_EVENT(e)       \
  if (this->parent) {             \
    if (this->parent->OnEvent(e)) \
      return true;                \
  }                               \
  return false;
#define GUI_FIRE_EVENT(e)                 \
  if (this->event_listener) {             \
    if (this->event_listener->OnEvent(e)) \
      return true;                        \
  }                                       \
...
#define GUI_FIRE_ELEMENT_EVENT(el, ev) \
  if ((el)->OnEvent((ev)))             \
    return;
