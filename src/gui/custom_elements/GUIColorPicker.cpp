...
GUIColorPicker::GUIColorPicker(GUIEnvironment* env, Rect2D<int> dimensions, bool drawbackground)
...
void GUIColorPicker::Render() {
  RenderChildren();
  environment->DrawSlicedGUIQuad(Rect2D<int>(absolute_rect.x + absolute_rect.w + 24 + 4, absolute_rect.y + 16 + 4, 24, 24),
                                 helpers::color255(secondaryColor.r, secondaryColor.g, secondaryColor.b, secondaryColor.a));
  environment->DrawSlicedGUIQuad(Rect2D<int>(absolute_rect.x + absolute_rect.w + 24, absolute_rect.y + 16, 24, 24),
                                 helpers::color255(primaryColor.r, primaryColor.g, primaryColor.b, primaryColor.a));
}