...
class GUIWindow : public GUIElement {
 ...
 public:
  GUIWindow(GUIEnvironment* env, Rect2D<int> dimensions, std::wstring tittleBarText = L"Window", bool clip = true, bool showClose = true,
            bool modal = false, bool draggable = true);
  virtual ~GUIWindow();
